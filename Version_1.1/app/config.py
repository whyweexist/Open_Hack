...
# ── PageIndex (reasoning-based hierarchical retrieval) ───────────────
PAGEINDEX_ENABLED = os.getenv("PAGEINDEX_ENABLED", "true").lower() == "true"
PAGEINDEX_MAX_DEPTH = int(os.getenv("PAGEINDEX_MAX_DEPTH", "3"))
PAGEINDEX_TOP_K = int(os.getenv("PAGEINDEX_TOP_K", "5"))
